...
const LoginScreen = () => {
    ...
    const { control, handleSubmit, watch, getFieldState, setError, clearErrors, resetField,
                            ...
                            <FormInputBlock>
                                <FormInputContainer>
                                    <FormInput
                                        ...
                                        onChangeText={onChange}
                                        value={value}
                                        style={{ borderColor: errors.password ? C.red : inputFocus2 }
                                ...
                                <FormInputLabel inputLabel={inputPasswordLabel}>Password</FormInputLabel>
